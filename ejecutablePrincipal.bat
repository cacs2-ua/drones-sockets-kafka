...
start cmd /k "python AD_Engine.py 0.0.0.0:4000 15 192.168.97.160:9092 127.0.0.2:5000"
...
FOR /L %%i IN (1,1,15) DO (
    start cmd /k "Python AD_Drone.py 127.0.0.1:4000 192.168.97.160:9092 127.0.0.1:65432 -d"
    timeout /t 1 /nobreak
)
